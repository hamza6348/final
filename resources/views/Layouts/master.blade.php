            ...
            <div class="row">
                    ...
                    <div class="form-box">
                        <div class="form-top">
                            <div class="form-top-left">
                                <h3>Login to our site as a Doctor</h3>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-bottom">
                            <form role="form" id="signUpForm" action="{{route('signup')}}" method="post" class="registration-form">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cnic" placeholder="CNIC" class="form-last-name form-control" id="cnic" required>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn">Sign me up as a Doctor!</button>
