    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-4 header-logo">
                <br>
                <a href="{{route('dashboard')}}"><h1>Medical Revolution </h1></a>
            </div>
                    ...
                    <div class="container-fluid nav-bar">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a class="menu" href="{{route('account')}}">EditAccount</a></li>
                                <li><a class="menu" href="{{route('patientadd')}}">Add Patient</a></li>
                                <li><a class="menu" href="{{route('logout')}}">Logout</a></li>
                            </ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-2">
                <form action="{{route('post.create')}}" method="post" role="form" enctype="multipart/form-data" class="facebook-share-box">
                    <div class="share">
                        <div class="arrow">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="PostArea">
                                    <textarea name="body" cols="40" rows="15" id="status_message" class="form-control message" style="height: 80px; overflow: hidden;" placeholder="What's on your mind ?"></textarea>
                                </div>
                            </div>
...
<section class="rowposts text-center">
    <h3>The wall</h3>
        ...
        <article class="post">
            ...
            <div class="interaction">
                ...
                @if(Auth::user()==$post->user)
                    <a href="{{route('post.delete',['post_id'=>$post->id])}}" class="btn btn-danger btn-lg">Remove <span class="glyphicon glyphicon-minus"></span></a>
                    <a href="" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-edit"></span>Edit</a><br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6 footer-para">
                <p>&copy;BabaG All right reserved</p>
            </div>
